...
public class App 
{
	...
	public static float calculatePrecision(StringBuilder docsFound, String queryContext) {
		Matcher m = Pattern.compile("/data/(.+)/").matcher(docsFound.toString()); //\\\\data\\\\(.+)\\\\
	...
	public static void main( String[] args )
    {
	    ...
	    //RESULT
	    System.out.print("\n"+ "TOP 6 RESULTS : " + consoleOutputAndMatchedDocs[0].toString());
	    
	    System.out.print("\n"+ "To calculate recall and presicion, Please enter the query context: ");
        ...
        System.out.println("\nOutput file is generated!" + "Please check the file");
    }
	    }